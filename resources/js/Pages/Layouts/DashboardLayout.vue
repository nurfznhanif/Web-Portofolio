<template>
  <div class="min-h-screen bg-gray-900">
    <!-- Sidebar -->
    <div
      class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 transform transition-transform duration-300 ease-in-out"
      :class="{
      ...
      <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
          <Link
            ...
            :class="{
              'bg-red-900 text-white': route().current('admin.dashboard'),
            }"
          >
          ...
          <Link
            ...
            class="flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors"
            :class="{
              'bg-red-900 text-white': route().current('admin.portfolio.*'),
            }"
          >
            <span class="mr-3">💼</span>
            Portfolio
          ...
          <Link
            ...
            class="flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors"
            :class="{
              'bg-red-900 text-white': route().current('admin.experience.*'),
            }"
          >
            <span class="mr-3">🏢</span>
            Experience
          ...
          <Link
            ...
            class="flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors"
            :class="{
              'bg-red-900 text-white': route().current('admin.skill.*'),
            }"
          >
        ...
        <div class="p-4 border-t border-gray-700">
          <div class="flex items-center">
            ...
            <form @submit.prevent="logout">
              <button
                type="submit"
                class="ml-2 p-2 text-gray-400 hover:text-red-400 transition-colors"
                title="Logout"
              >
                🚪
              </button>
