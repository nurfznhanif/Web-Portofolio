<!-- resources/js/Pages/Admin/Interest/Edit.vue -->
<script setup>
...
const form = useForm({
  ...
  color: props.interest.color || "#3b82f6",
  is_featured: props.interest.is_featured || false,
});
...
// Methods
const submitForm = () => {
  form.put(`/admin/interests/${props.interest.id}`, {
    onSuccess: () => {
...
const breadcrumbs = [
  ...
  {
    name: "Edit",
    href: `/admin/interests/${props.interest.id}/edit`,
    current: true,
  },
];
</script>
...
<template>
  ...
  <DashboardLayout :title="'Edit Interest'" :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div
              ...
              :style="getColorStyle(props.interest.color)"
            >
              {{ props.interest.icon }}
            </div>
            <div>
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Update the details of "{{ props.interest.name }}"
              </p>
            </div>
          </div>
          <div class="flex items-center space-x-4">
            <span
              v-if="props.interest.is_featured"
