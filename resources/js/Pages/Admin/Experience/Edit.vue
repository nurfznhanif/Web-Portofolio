...
const submitForm = () => {
  ...
  form.patch(`/admin/experience/${props.experience.id}`, {
    onSuccess: () => {
...
const breadcrumbs = [
  ...
  {
    name: "Edit",
    href: `/admin/experience/${props.experience.id}/edit`,
    current: true,
  },
];
</script>
...
<template>
  <Head :title="`Edit ${experience.position}`" />

  <DashboardLayout :title="`Edit Experience`" :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
              Update experience details for: {{ experience.position }} at
            ...
            <div class="flex-1">
              ...
              >
                <span class="flex items-center">
                  ...
                  {{ form.is_current ? "Present" : formatDate(form.end_date) }}
                </span>
              </div>
              <div class="mt-4">
        ...
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-red-600 dark:text-red-400">
              Permanently delete this experience entry. This action cannot be
              undone.
            </p>
          </div>
