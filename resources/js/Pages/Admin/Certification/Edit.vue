<!-- resources/js/Pages/Admin/Certification/Edit.vue -->
<script setup>
...
const breadcrumbs = [
  ...
  {
    name: "Edit",
    href: `/admin/certifications/${props.certification.id}/edit`,
    current: true,
  },
];
</script>
...
<template>
  ...
  <DashboardLayout :title="'Edit Certification'" :breadcrumbs="breadcrumbs">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Update the details of "{{ props.certification.name }}"
            </p>
          </div>
        ...
        >
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              ...
              {{ form.processing ? "Updating..." : "Update Certification" }}
            </button>
          </div>
        </div>
      </div>
