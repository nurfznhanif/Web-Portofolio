...
class PortfolioSeeder extends Seeder
{
    public function run(): void
    {
        ...
        ProfileSetting::create([
            ...
            'summary' => 'A graduate of the Informatics Engineering Program, Faculty of Engineering, Islamic University of Riau, with intermediate proficiency in programming using PHP, Python, and JavaScript. Skilled in Microsoft Word (advanced), Excel (intermediate), and PowerPoint (basic). Passionate about Web Programming, Mobile Development, Artificial Intelligence, and Data Analysis. Actively engaged in both campus and off-campus organizations, with experience as a Teaching Assistant. Highly motivated to continuously learn and grow in the field of technology, and eager to contribute effectively as a valuable member of a team through the skills and knowledge acquired.',
            ...
            'thesis_title' => 'Aspect-Based Sentiment Analysis on the Golden Generation 2045 Discourse in Social Media Using Latent Dirichlet Allocation and Bidirectional Encoder Representations from Transformers',
            'availability' => [
        ...
        Experience::create([
            ...
            'organization' => 'Student Service Camp – Informatics Engineer Student Association',
        ...
        Achievement::create([
            ...
            'issuer' => 'Islamic University of Riau',
            'description' => 'Graduated with excellent academic performance in Informatics Engineer program',
