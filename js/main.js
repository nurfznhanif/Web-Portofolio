...
(function () {
  ...
  const ID = {
    ...
    "hero.roles": 'Web Developer Full-stack <span class="sep">·</span> Analis Data',
    "hero.lede": 'Saya merancang dan membangun aplikasi web dan dasbor data — dari platform <em>Laravel &amp; Vue</em> hingga analitik <em>Power BI</em> — mengubah kebutuhan yang rumit menjadi produk yang rapi dan andal.',
    ...
    "sec.about": "Tentang",
    "about.lead": "Lulusan Teknik Informatika dengan naluri membangun — sama nyamannya menyiapkan basis data, merilis antarmuka Vue, atau memodelkan data untuk sebuah dasbor.",
    "about.p1": "Saya memiliki kemampuan menengah dalam <strong>PHP</strong>, <strong>Python</strong>, dan <strong>JavaScript</strong>, dan senang bekerja di seluruh lapisan — dari API back-end hingga front-end yang rapi. Minat saya mencakup pengembangan web, pengembangan mobile, kecerdasan buatan, dan analisis data.",
    ...
    "fact.now.k": "Saat ini", "fact.now.v": "Asisten — Regional Strategy &amp; Finance", "fact.now.sub": "PT Mutualplus @ BRI Kantor Wilayah II Pekanbaru",
    ...
    "thesis.tag": "Skripsi",
    "thesis.title": "Analisis Sentimen Berbasis Aspek terhadap Diskursus “Generasi Emas 2045” di Media Sosial menggunakan Latent Dirichlet Allocation (LDA) dan BERT",

    "sec.experience": "Pengalaman",
    "exp1.when": "Nov 2025 — Sekarang", "exp1.role": "Asisten — Regional Strategy &amp; Finance",
    "exp1.org": "PT Mutualplus (alih daya) @ BRI Kantor Wilayah II Pekanbaru",
